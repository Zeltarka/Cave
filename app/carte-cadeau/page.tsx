...
export default function CarteCadeauPage() {
  ...
  const ajouterAuPanier = async () => {
    ...
    try {
        const safeName = destinataire.trim().replace(/\s+/g, "-"); // remplace les espaces par des tirets
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      ...
      </h1><p className={"text-center "}>Vous recevrez une carte cadeau dématérialisée<br/> <br/></p>
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start gap-8 lg:gap-16 xl:gap-24 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col gap-6 w-full max-w-md">
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600 text-center">Montant minimum : 10€</p>
          </div>

          <button
            onClick={ajouterAuPanier}
            disabled={disabled || montantNum < 10 || !destinataire.trim()}
