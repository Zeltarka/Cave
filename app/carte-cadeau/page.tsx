    ...
    const ajouterAuPanier = async () => {
        ...
        try {
            ...
            const res = await fetch("/api/commandes", {
                ...
                body: JSON.stringify({
                    id: uniqueId, // ← CORRECTION : utiliser uniqueId comme ID principal
                    produit: `Carte cadeau ${montantNum.toFixed(2)}€`, // ← Description plus précise
                    quantite: 1,
                    prix: montantNum,
            ...
            // ← CORRECTION : vérifier juste res.ok, pas data.success
            if (!res.ok) {
