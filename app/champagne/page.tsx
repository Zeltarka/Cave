...
export default function page() {
    ...
    const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        const quantitec = parseInt(event.target.value);
        if (!isNaN(quantitec) && quantitec >= 0) {
            setQuantitec(quantitec);
        }else{
                setQuantitec(1);
            }
        }

    const augmenter = () => setQuantitec((q) => q + 1);
    const diminuer = () => setQuantitec((q) => Math.max(0, q - 1));
            ...
            <div style={{
                ...
                <button style={{
                    ...
                    <div style={{
                        ...
                        <label htmlFor="quantitec" style={{fontSize:'18px'}}>Quantité: </label>
