...
export default function Page() {
    ...
    const [bouteillesRoseExistantes, setBouteillesRoseExistantes] = useState(0);
    const [bouteillesChampagne, setBouteillesChampagne] = useState(0);
    ...
    const fetchPanier = () => {
        fetch("/api/commandes")
            ...
            .then((panier: { id: string; quantite: number }[]) => {
                ...
                setBouteillesRoseExistantes(rose?.quantite || 0);
                setBouteillesChampagne(champagne?.quantite || 0);
            })
            .catch(() => {});
    };
    ...
    const maxDispo = 24 - bouteillesRoseExistantes - bouteillesChampagne;
    ...
    }, [bouteillesRoseExistantes, bouteillesChampagne]);
    ...
    const ajouterAuPanier = async () => {
        ...
        try {
            const res = await fetch("/api/commandes", {
                ...
                body: JSON.stringify({ id: "rose", produit: contenu.titre, quantite: quantitec, prix: contenu.prix }),
            });
            await res.json();
