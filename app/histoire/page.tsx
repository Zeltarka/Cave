export default function page(){
    return(
        <div
            ...
            <p>La Cave La Garenne est née en juin 2017. C’est une entreprise indépendante. <br/><br/>
                ...
                propre entreprise…dans le vin! <br/><br/>
                ...
                5 et 10 € sur chaque Région.<br/><br/>
                ...
                cru et l’année «racontentet expliquent » beaucoup de chose.<br/><br/>
                ...
                conseil dédié à chaque client, à chaque instant de l’année.<br/><br/>
                Avec joie de vous recevoir à La Cave La Garenne!</p>
        </div>
    );
}