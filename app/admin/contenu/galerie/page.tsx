...
function GalerieEditor() {
    ...
    const ajouterPhoto = () => {
        setContenu(prev => {
            if (!prev) return null;
            const nouvelOrdre = prev.photos.length > 0
                ? Math.max(...prev.photos.map(p => p.ordre)) + 1
                : 0;
        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <h1 className="text-2xl font-bold text-[#24586f]">Éditer Galerie</h1>
                        </div>
                        <button
                            onClick={sauvegarder}
                            disabled={saving}
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="space-y-6">
                    ...
                    {/* Photos */}
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        <h3 className="text-lg font-semibold text-[#24586f] mb-4">Photos</h3>
                                    ...
                                    <div key={index} className="border border-gray-200 rounded-lg p-6">
                                        <div className="flex justify-between items-center mb-4">
                                            ...
                                            <div className="flex gap-2">
                                                <button
                                                    onClick={() => deplacerPhoto(index, "haut")}
                                                    disabled={index === 0}
                                                ...
                                                <button
                                                    onClick={() => deplacerPhoto(index, "bas")}
                                                    disabled={index === contenu.photos.length - 1}
                                                    className="p-2 text-gray-600 hover:bg-gray-100 rounded disabled:opacity-30"
                                                >
                                                    ↓
                                                </button>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex gap-4">
                                                    <label className="flex items-center cursor-pointer">
                                                        <input
                                                            ...
                                                            value="paysage"
                                                            checked={photo.orientation === "paysage" || !photo.orientation}
                                                            onChange={(e) => mettreAJourPhoto(index, "orientation", e.target.value)}
                                                            className="mr-2"
                                                        />
                                                    ...
                                                    <label className="flex items-center cursor-pointer">
                                                        <input
                                                            ...
                                                            name={`orientation-${index}`}
                                                            value="portrait"
                                                            checked={photo.orientation === "portrait"}
                                                            onChange={(e) => mettreAJourPhoto(index, "orientation", e.target.value)}
                                                            className="mr-2"
                                                        />
                                                        <span className="text-sm">
                                                ...
                                                <p className="text-xs text-gray-500 mt-1">
                                                    Les photos en portrait prendront plus de hauteur dans la grille
                                                </p>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    type="text"
                                                    value={photo.legende}
                                                    onChange={(e) => mettreAJourPhoto(index, "legende", e.target.value)}
                        ...
                        <button
                            ...
                            className="mt-6 w-full px-6 py-3 border-2 border-dashed border-[#24586f] text-[#24586f] rounded-lg hover:bg-[#24586f] hover:text-white transition-colors font-medium"
                        >
                            + Ajouter une photo
                        </button>
                    </div>
