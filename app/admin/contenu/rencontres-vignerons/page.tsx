...
function RencontresEditor() {
    const [contenu, setContenu] = useState<RencontresContenu>({ blocs: [] });
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div key={index} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <div className="flex justify-between items-center mb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-sm text-gray-600 capitalize">{bloc.type}</span>
                                </div>
                            ...
                            <RichTextEditor
                                ...
                                placeholder={bloc.type === "titre" ? "Entrez un titre..." : "Entrez un paragraphe..."}
                            />
                        </div>
                    ))}
                </div>
                ...
                <div className="mt-8">
                    <button onClick={ajouterBloc} className="w-full px-6 py-4 border-2 border-dashed border-[#24586f] text-[#24586f] rounded-lg hover:bg-[#24586f] hover:text-white transition-colors font-medium">
